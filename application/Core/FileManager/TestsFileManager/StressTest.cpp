...
void StressTest::newFile()
{
   ...
   Common::ProtoHelper::setStr(entry, &Protos::Common::Entry::mutable_path, path);
   Common::ProtoHelper::setStr(entry, &Protos::Common::Entry::mutable_name, this->randGen.generateAName());
